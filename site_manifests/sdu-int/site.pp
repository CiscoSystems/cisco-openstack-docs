...
http_proxy="http://proxy-rtp-1.cisco.com:8080"
https_proxy="https://proxy-rtp-1.cisco.com:8080"
'
   }
...
node base {
  ...
  class { puppet:
    run_agent => true,
    puppetmaster_address => "build-os.sdu.lab",
  }
...
node flat_dhcp inherits base {
  ...
  $controller_node_internal = '10.16.205.61'
  $controller_node_public   = '10.16.205.61' 
  $sql_connection           = "mysql://nova:${nova_db_password}@${controller_node_internal}/nova"
...
node /control-1/ inherits flat_dhcp {
...
#  class { 'nova::volume::iscsi': }
  ...
  class { 'openstack::controller':
    ...
    floating_range          => '10.16.205.96/27',
